...
export const WORD_BANK_DIALOG_LAYOUT_CLASS = "max-h-[90vh] max-w-[min(1280px,calc(100%-1rem))] overflow-hidden border-[#dfd4bf] bg-[#fffdf7] p-0 sm:max-w-[min(1280px,calc(100%-2rem))]";
