...
import c1Module10AuthoredActivities from "./c1-module-10-authored-activities";
import { C1_MODULE_10_EXPERIENCES } from "./c1-module-10-experiences";
...
export const C1_LESSONS: LessonDefinition[] = (rawDraft as DraftLesson[]).map((draft) => ({
  ...
  ...lesson,
  activities: c1Module10AuthoredActivities[lesson.lessonNumber] ?? c1Module9AuthoredActivities[lesson.lessonNumber] ?? c1Module8AuthoredActivities[lesson.lessonNumber] ?? c1Module7AuthoredActivities[lesson.lessonNumber] ?? c1Module6AuthoredActivities[lesson.lessonNumber] ?? c1Module5AuthoredActivities[lesson.lessonNumber] ?? (c1Module4AuthoredActivities[lesson.lessonNumber]
