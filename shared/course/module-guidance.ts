...
export const COURSE_MODULE_THEMES: Record<CefrLevel, CourseModuleTheme[]> = {
  ...
  C1: [
    ...
    { title: "Language and Meaning", titleArabic: "اللغة والمعنى", overview: "Control ambiguity, implication, and register across demanding texts.", overviewArabic: "تحكم في الغموض والإيحاء والسجل اللغوي عبر نصوص صعبة." },
    { title: "Institutions and Trust", titleArabic: "المؤسسات والثقة", overview: "Evaluate public language, authority, legitimacy, and accountability.", overviewArabic: "قيّم لغة المؤسسات والسلطة والشرعية والمساءلة." },
    { title: "Research and Interpretation", titleArabic: "البحث والتفسير", overview: "Compare sources, frame interpretations, and distinguish evidence from inference.", overviewArabic: "قارن المصادر وصغ التفسيرات وميّز بين الدليل والاستنتاج." },
    { title: "Ethics and Responsibility", titleArabic: "الأخلاق والمسؤولية", overview: "Discuss complex dilemmas with nuance, fairness, and explicit qualification.", overviewArabic: "ناقش المعضلات المعقدة بدقة وإنصاف وتقييد واضح." },
    { title: "Creative and Critical Voice", titleArabic: "الصوت الإبداعي والنقدي", overview: "Shape a controlled voice for critique, reflection, and public communication.", overviewArabic: "شكّل صوتاً مضبوطاً للنقد والتأمل والتواصل العام." },
    { title: "Independent Synthesis", titleArabic: "التركيب المستقل", overview: "Integrate multiple perspectives into a defensible, audience-aware position.", overviewArabic: "ادمج وجهات نظر متعددة في موقف قابل للدفاع وواعٍ بالجمهور." },
  ],
  C2: [
    ...
    { title: "Science and Uncertainty", titleArabic: "العلم وعدم اليقين", overview: "Communicate complex evidence without overstating certainty.", overviewArabic: "تواصل الأدلة المعقدة دون مبالغة في اليقين." },
    { title: "Memory and Narrative", titleArabic: "الذاكرة والسرد", overview: "Interrogate inherited stories, perspective, and the ethics of representation.", overviewArabic: "حلّل القصص الموروثة والمنظور وأخلاقيات التمثيل." },
    { title: "Markets and Value", titleArabic: "الأسواق والقيمة", overview: "Evaluate economic language, distribution, and competing definitions of value.", overviewArabic: "قيّم اللغة الاقتصادية والتوزيع والتعريفات المتنافسة للقيمة." },
    { title: "Institutions and Legitimacy", titleArabic: "المؤسسات والشرعية", overview: "Rewrite institutional discourse with visible agency and accountability.", overviewArabic: "أعد صياغة الخطاب المؤسسي مع إظهار الفاعل والمساءلة." },
    { title: "Art and Interpretation", titleArabic: "الفن والتفسير", overview: "Make nuanced interpretive claims while respecting ambiguity and evidence.", overviewArabic: "قدّم ادعاءات تفسيرية دقيقة مع احترام الغموض والدليل." },
    { title: "Language and Power", titleArabic: "اللغة والقوة", overview: "Trace how wording distributes attention, authority, and opportunity.", overviewArabic: "تتبّع كيف توزع الصياغة الانتباه والسلطة والفرص." },
    { title: "Public Deliberation", titleArabic: "المداولة العامة", overview: "Mediate disagreement and build responsible shared understanding.", overviewArabic: "توسط في الخلاف وابنِ فهماً مشتركاً مسؤولاً." },
    { title: "Final Independent Studio", titleArabic: "الاستوديو المستقل النهائي", overview: "Synthesize demanding material into a precise original intervention.", overviewArabic: "ركّب مادة صعبة في مداخلة أصلية دقيقة." },
  ],
};
