...
const SPECS: ModuleSpec[] = [
  {
    ...
    vocabulary: ["family", "mother", "father", "sister", "brother", "home", "room", "kitchen", "bedroom", "table", "chair", "door", "window", "phone", "bag", "book"],
    vocabularyArabic: ["عائلة", "أم", "أب", "أخت", "أخ", "منزل", "غرفة", "مطبخ", "غرفة نوم", "طاولة", "كرسي", "باب", "نافذة", "هاتف", "حقيبة", "كتاب"],
